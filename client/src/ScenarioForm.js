...
function ScenarioForm(){ 
    ...
    <form id="scenario-form" >
        ...
        {/*birthYear*/}
        <div><label>Your Birth Year<span className="required">*</span></label>
            <input
                type="number"
                name="birthYear"
        ...
        {/*life expectancy*/}
        <div>
            <label>Your Life Expectancy<span className="required"> *</span></label>
            <div className="radio-group2">
                ...
                <div className="radioOpt">
                    ...
                    {scenario.lifeExpectancy_opt === "fixed" && (
                        ...
                        <input
                            type="number"
                            name="lifeExpectancy_value" 
                            value={scenario.lifeExpectancy_value}
                            onChange={handleChange}
                            required
                        /> 
                        </>
        ...
        {/*maritialStatus: */}
        <div> 
            <label>Maritial Status <span className="required">*</span></label>
        ...
        {scenario.maritialStatus === "married" && (
            <> 
                {/*spouse birthYear*/}  
                <div>
                    <label>Spouse Birth Year<span className="required">*</span></label>
                    <input
                        type="number"
                        name="birthYear_spouse"
                        value={scenario.birthYear_spouse}
                        onChange={handleChange}
                        required
                    />   
                </div>
                ...
                <div> 
                    <label>Spouse Life Expectancy<span className="required">*</span></label>
                    <div className="radio-group2">
                        {/*opt: fixed*/} 
                        <div className="radioOpt"> 
                            <label>
        ...
        {/*Investments*/}
        <div> 
            <label>Investments<span className="required"> *</span></label>
        ...
        {/*Event series*/}
        <div> 
            <label>Event Series<span className="required"> *</span></label>
        ...
        {/*withdrawal strategy*/}
        <div>
            <label>Expense Withdrawal Strategy<span className="required"> *</span></label>
        ...
        {/*inflation: */}
        <div>
            <label>Inflation<span className="required"> *</span></label>
            <input
                type="number"  
                name="inflation"
        ...
        <div> 
            <label>Pre-tax retirement account contribution limit<span className="required"> *</span></label>
            <input
                type="number"
                name="pre_contribLimit"
                value={scenario.pre_contribLimit}
                onChange={handleChange} 
                required
            /> 
        </div> 
        ...
        <div>
            ...
            <div> 
                ...
                {scenario.has_rothOptimizer === "rothOptimizer_on" && (
                    <> 
                        <div className="radioOpt">
                            <label>Target Tax Bracket<span className="required"> *</span></label>
        ...
        <div> 
            ...
            <input
                type="number"
                name="after_contribLimit"
                value={scenario.after_contribLimit}
                onChange={handleChange} 
                required
            /> 
        </div> 
